...
<head>
    ...
    <link rel="stylesheet" href="css/order/orderMake.css">
</head>
<!-- select -->
<script
        ...
        $('#orderAddBtn').click(function () {
            ...
            $.ajax({
                ...
                success: function (vo) {
                    ...
                    var cNo = (vo.product_number).toString();
                    ...
                    var tagAdd = "<div class ='testForm'><input type = 'hidden' name = 'no' class ='tagInputAdd' value=" + vo.product_price + ">"
                        + "<input type ='text' name = 'itemName' title='" + vo.product_name + "' class ='tagAddDiv' readonly value='" + longName + "'>"
                        + "<input type = 'text' name = 'itemPrice' class ='tagAddDiv' readonly value=" + vo.product_price + ">"
    ...
    <div id="orderWrapper">
        ...
        <div class="orderInfo">
            ...
            <div class="orderInfo-order-select-wrapper">
                ...
                <c:import url="orderSelect.jsp">
                    <c:param name="ProductGroup" value="1"></c:param>
                </c:import>
